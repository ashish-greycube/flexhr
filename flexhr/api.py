...
def before_install():
	...
	import_file(doctype='Email Template', file_path=frappe.utils.get_bench_path()+'/apps/flexhr/flexhr/public/email_template/Email_Template.csv', import_type="Insert", submit_after_import=False, console=False)        
